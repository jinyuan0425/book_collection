...
RSpec.describe "Books", type: :request do
    describe "POST /books" do
        context "when the request is valid (sunny-day scenario)" do
            ...
            post books_path, params: { book: { title: "New Book", author: "John Doe", price: 25.99, published_date: "2025-01-01" } }
        ...
        context "when the request is invalid (rainy-day scenario)" do
            it "does not add the book and shows an error flash notice" do
                post books_path, params: { book: { title: "", author: "John Doe", price: 25.99, published_date: "2025-01-01"  } }
            ...
            it "does not create a book without an author and shows an error flash notice" do
                post books_path, params: { book: { title: "New Book", author: nil, price: 25.99, published_date: "2025-01-01" } }
            ...
            it "does not create a book without a price and shows an error flash notice" do
                post books_path, params: { book: { title: "New Book", author: "John Doe", price: nil, published_date: "2025-01-01" } }
            ...
            it "does not create a book with a non-numeric price and shows an error flash notice" do
                post books_path, params: { book: { title: "New Book", author: "John Doe", price: "abc", published_date: "2025-01-01" } }
            ...
            it "does not create a book without a published_date and shows an error flash notice" do
                post books_path, params: { book: { title: "New Book", author: "John Doe", price: 25.99, published_date: nil } }
